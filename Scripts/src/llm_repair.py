...
def get_llm_repair_or_regenerate_prompt(code, err_msg, src_code):
    prompt = f"""Fix the bug in JMH code according to the compilation message or regenerate the JMH benchmark tests according to Source Code if needed.
